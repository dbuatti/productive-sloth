                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button 
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            // *** FIX: Pass isFlexible flag to toggleScheduledTaskLock ***
                            toggleScheduledTaskLock({ taskId: scheduledItem.id, isLocked: !isLocked, isFlexible: scheduledItem.isFlexible });
                          }}
                          className={cn(
