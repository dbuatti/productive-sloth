...
const SettingsPage: React.FC = () => {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      lunch_time: '12:00',
      dinner_time: '18:00',
      breakfast_duration_minutes: 30, // NEW
      lunch_duration_minutes: 45,     // NEW
      dinner_duration_minutes: 60,    // NEW
    },
    mode: 'onChange',
  });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between">
                  ...
                  <FormControl>
                    <Input type="number" className="w-auto" {...field} value={field.value || ''} min="5" max="120" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
