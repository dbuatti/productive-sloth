...
export interface ScheduleSummary {
  totalScheduledDuration: number; // Keep existing
  totalBreakDuration: number;     // Keep existing
  totalFreeTime: number;          // Keep existing
  unscheduledCount: number;       // Keep existing
  workdayStart: Date;             // Keep existing
  workdayEnd: Date;               // Keep existing
